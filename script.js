...
$(".search").on("click", function() {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + theCity + "&appid=6207267bd46ac15a2d2b757882df58da";
    var queryURL2 = "https://api.openweathermap.org/data/2.5/forecast?q=" + theCity + "&appid=6207267bd46ac15a2d2b757882df58da";
    var lat;
    var lon;
...
//This calls the current weather conditions from open weather map. Then adds the different fields to the html.
    $.ajax({
        ...
        queryURL = "https://api.openweathermap.org/data/2.5/uvi/forecast?&appid=6207267bd46ac15a2d2b757882df58da" + lat + "&lon=" + lon;
